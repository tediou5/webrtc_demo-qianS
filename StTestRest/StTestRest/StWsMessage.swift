...
//    }
    ...
    init(ssid: Int, cmd: Command, type: MsgType, info: String, from: String, to: String) {
        self.ssid = ssid
        self.cmd = cmd
        self.type = type
        self.info = info
    ...
    convenience init(ssid: Int, info: String, from: String, to: String) {
        self.init(ssid: ssid, cmd: Command.NULL, type: MsgType.None, info: info, from: from, to: to)
    }
    
    convenience init(ssid: Int, cmd: Command, type: MsgType, info: String) {
    ...
    func getType() -> MsgType {
        return self.type
    }
    
    func setType(type: MsgType) -> Void {
        self.type = type
    }
...
//import HandyJSON
//
//enum Command: Int, HandyJSONEnum{
//
//    case NULL = 0x00
//    case APPLY_ADD_DEVICE = 0x30
//    case GRANT_ADD_DEVICE = 0x31
...
//}
//
//enum stType: String, HandyJSONEnum{
//    case None = "None"
//    case Request = "Request"
//    case Allow = "Allow"
//    case Deny = "Deny"
...
//        mapper <<<
//        self.cmd <-- EnumTransform()
//
//        mapper <<<
//        self.dst <-- "StWsMessage_dst"
//
//        mapper <<<
//        self.info <-- "StWsMessage_info"
//
//        mapper <<<
//        self.len <-- "StWsMessage_len"
//
//        mapper <<<
//        self.opt <-- "StWsMessage_opt"
//
//        mapper <<<
//        self.src <-- "StWsMessage_src"
//
//        mapper <<<
//        self.ssid <-- "StWsMessage_ssid"
//
//        mapper <<<
//        self.type <-- EnumTransform()
//    }
//
