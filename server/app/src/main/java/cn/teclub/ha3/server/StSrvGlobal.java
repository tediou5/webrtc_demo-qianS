...
import cn.teclub.ha3.server.core.StSrvConfig;
import cn.teclub.ha3.server.core.StSrvDao;
import cn.teclub.ha3.server.util.StAuthCodeMgr;
import cn.teclub.ha3.server.util.StTokenMgr;
...
public class StSrvGlobal
{
    ...
    public final StSrvConfig           conf;
    public final StSrvDao              dao;
    public final StTokenMgr            tokenMgr;
    public final StAuthCodeMgr         authCodeMgr;

    private StSrvGlobal(){
        this.conf = StSrvConfig.instance();
        this.dao = StSrvDao.instance();
        this.tokenMgr = StTokenMgr.instance();
        this.authCodeMgr = StAuthCodeMgr.instance();
    }
}
