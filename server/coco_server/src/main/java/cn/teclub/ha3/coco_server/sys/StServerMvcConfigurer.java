...
import cn.teclub.ha3.coco_server.sys.interceptor.StStatsInterceptor;
import cn.teclub.ha3.coco_server.sys.interceptor.StUserInterceptor;
 ...
 */
@Configuration
public class StServerMvcConfigurer implements WebMvcConfigurer {
    @Autowired
