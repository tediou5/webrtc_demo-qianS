...
public class StStatsInterceptor implements HandlerInterceptor {
    ...
    @Autowired
    StApplicationProperties stApplicationProperties;
    //@Autowired
    ...
    public void afterCompletion(HttpServletRequest request, HttpServletResponse response, Object handler, Exception ex) {
        ...
        try {
            ...
            MDC.put("fs.stats.request_end", serverUtil.formatTimestamp(end));
            Long begin = Long.valueOf(MDC.get("fs.stats.request_begin"));
            MDC.put("fs.stats.request_begin", serverUtil.formatTimestamp(begin));
