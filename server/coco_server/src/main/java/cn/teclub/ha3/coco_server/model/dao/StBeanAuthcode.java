 ...
 * @author Tao Zhang
 *
 * @deprecated [Theodor: 2019/11/27] move into controller, save in runtime
 */
public class StBeanAuthcode implements Serializable {
    private Integer id;
    ...
    public boolean equals(Object that) {
        ...
        StBeanAuthcode other = (StBeanAuthcode) that;
